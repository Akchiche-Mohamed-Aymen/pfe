...
function Consulting() {
    ...
    return (
        <div className="p-8 bg-gray-100 min-h-screen">
            <h1 className="text-3xl font-bold text-blue-600 mb-6">Consulting Advice</h1>
            ...
            <div className="space-y-4">
                {consultations.map((consultation) => (
                    ...
                    >
                        <h2 className="text-xl font-bold text-gray-800">{consultation.topic}</h2>
                        <p className="text-gray-600 italic">By {consultation.expert}</p>
                        <p className="mt-2 text-gray-700">{consultation.message}</p>
                        <p className="text-sm text-gray-500 mt-3">Date: {consultation.date}</p>
                    </div>
                ))}
            </div>
        </div>
